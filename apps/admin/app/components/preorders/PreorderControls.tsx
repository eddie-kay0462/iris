...
export function PreorderSourceBadge({ source }: { source: "online" | "popup" }) {
  return (
    <span
    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className={`absolute z-20 mt-1 w-44 rounded-lg border border-slate-200 bg-white shadow-lg py-1 ${align === "right" ? "right-0" : "left-0"}`}>
            <button
