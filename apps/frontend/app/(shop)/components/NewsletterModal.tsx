      ...
      {open && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          <motion.div
            ...
            className="relative z-10 grid w-full max-w-3xl grid-cols-1 overflow-hidden bg-white shadow-2xl sm:grid-cols-2"
          >
            <button
              onClick={dismiss}
              aria-label="Close newsletter sign-up"
              className="absolute right-3 top-3 z-20 flex h-9 w-9 items-center justify-center border border-neutral-200 bg-white/90 text-neutral-900 transition hover:bg-neutral-100"
            >
            ...
            <div className="flex flex-col justify-center px-7 py-12 sm:px-9">
              <div className="flex items-center gap-3 text-[10px] font-medium uppercase tracking-[0.4em] text-neutral-400 font-mono">
              ...
              <h2
                ...
                className="mt-5 text-2xl sm:text-3xl font-bold uppercase leading-[1.05] tracking-tight text-neutral-900"
                ...
                <>
                  <form onSubmit={handleSubmit} className="mt-8 space-y-3">
                    <input
                      ...
                      className="w-full border border-neutral-300 bg-white px-4 py-3 text-sm text-neutral-900 placeholder-neutral-400 transition focus:border-neutral-900 focus:outline-none"
                    />
                    <button
                      type="submit"
                      disabled={status === "loading"}
                      className="w-full bg-neutral-950 px-8 py-3.5 text-xs font-semibold uppercase tracking-[0.25em] text-white transition hover:opacity-85 disabled:opacity-40"
                    >
                  ...
                  <button
                    onClick={dismiss}
                    className="mt-5 self-center text-[10px] font-medium uppercase tracking-[0.25em] text-neutral-400 transition hover:text-neutral-900 font-mono"
                  >
                    No thanks
                  </button>
                </>
