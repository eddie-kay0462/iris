      ...
      <section className="border-b border-line px-6 pt-24 pb-16">
        <div className="mx-auto max-w-5xl">
          <motion.div
            ...
            variants={stagger}
          >
            <motion.div variants={fadeUp} className="flex items-center gap-3 text-[10px] font-medium uppercase tracking-[0.4em] text-text-muted font-mono">
              <span>About</span>
            ...
            <motion.h1 variants={fadeUp} className="display mt-8 text-5xl sm:text-7xl lg:text-[5.5rem] font-bold uppercase tracking-tight leading-[0.95]">
              Built in Accra.<br />
              <span className="text-text-muted">Worn everywhere.</span>
            </motion.h1>

            <motion.p variants={fadeUp} className="mt-10 max-w-2xl text-lg sm:text-xl text-text-secondary leading-relaxed">
            ...
            {/* Meta strip */}
            <motion.div variants={fadeUp} className="mt-12 grid grid-cols-2 sm:grid-cols-4 gap-y-6 gap-x-8 border-t border-line pt-8">
              <div>
                <div className="font-mono text-[10px] uppercase tracking-[0.3em] text-text-muted">Headquartered</div>
                <div className="mt-2 text-sm font-medium">Accra, Ghana</div>
              </div>
              <div>
                <div className="font-mono text-[10px] uppercase tracking-[0.3em] text-text-muted">Production</div>
                <div className="mt-2 text-sm font-medium">Ghana</div>
              </div>
              <div>
                <div className="font-mono text-[10px] uppercase tracking-[0.3em] text-text-muted">Markets</div>
                <div className="mt-2 text-sm font-medium">GH · NG · UK · CA · US</div>
              </div>
              <div>
                <div className="font-mono text-[10px] uppercase tracking-[0.3em] text-text-muted">Sector</div>
      ...
      <section className="px-6 py-24 sm:py-32">
        <div className="mx-auto max-w-5xl grid grid-cols-1 lg:grid-cols-[200px_1fr] gap-10 lg:gap-16">
          <motion.div
            ...
            variants={fadeUp}
          >
            <div className="font-mono text-[10px] uppercase tracking-[0.4em] text-text-muted">Ch. 01</div>
            <div className="mt-2 text-xs uppercase tracking-widest text-text-secondary">The Story</div>
          </motion.div>
          ...
          <motion.div
            ...
            viewport={viewport}
            variants={stagger}
            className="space-y-6 text-base sm:text-lg leading-relaxed text-text-secondary"
          >
            <motion.p variants={fadeUp} className="text-xl sm:text-2xl text-text">
      ...
      <section className="border-t border-b border-line bg-surface-subtle px-6 py-24 sm:py-32">
        <div className="mx-auto max-w-5xl">
          ...
          <motion.div
            ...
            className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-px bg-fill border border-line"
          >
            <motion.article variants={fadeUp} className="bg-surface-subtle p-8">
      ...
      <section className="px-6 py-24 sm:py-32">
        <div className="mx-auto max-w-5xl grid grid-cols-1 lg:grid-cols-[200px_1fr] gap-10 lg:gap-16">
          <motion.div
            ...
            variants={fadeUp}
          >
            <div className="font-mono text-[10px] uppercase tracking-[0.4em] text-text-muted">Ch. 03</div>
            <div className="mt-2 text-xs uppercase tracking-widest text-text-secondary">What&rsquo;s next</div>
          </motion.div>
          ...
          <motion.div
            ...
            variants={stagger}
          >
            <motion.p variants={fadeUp} className="display text-3xl sm:text-4xl lg:text-5xl font-semibold uppercase tracking-tight leading-tight text-text">
              We&rsquo;re building a circular production strategy;{" "}
              <span className="text-text-muted">textile recovery, upcycling, waste reduction</span>{" "}; into the way we make clothes.
            </motion.p>
            <motion.p variants={fadeUp} className="mt-8 max-w-2xl text-base sm:text-lg text-text-secondary leading-relaxed">
      ...
      <section className="px-6 py-24 sm:py-32">
        <div className="mx-auto max-w-5xl">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="mt-4 max-w-xl text-base sm:text-lg text-text-secondary leading-relaxed">
              Drops, sit-downs from the studio, behind-the-machines footage from Ghana; choose your platform.
            </motion.p>
          </motion.div>

          <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-px bg-fill border border-line">
            <a
              href="https://instagram.com/_1nriworldwide"
              target="_blank"
              rel="noopener noreferrer"
              className="group bg-surface-subtle p-6 flex flex-col gap-6 transition hover:bg-surface"
            >
              <svg className="h-7 w-7 text-text" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <div className="font-mono text-[10px] uppercase tracking-[0.3em] text-text-muted">Instagram</div>
                <div className="mt-1 text-sm font-medium">@_1nriworldwide</div>
              </div>
              <div className="mt-auto inline-flex items-center gap-2 text-[10px] font-mono uppercase tracking-[0.3em] text-text-muted group-hover:text-text transition">
                Follow
            ...
            >
              ...
              <div>
                <div className="font-mono text-[10px] uppercase tracking-[0.3em] text-text-muted">TikTok</div>
            ...
            >
              ...
              <div>
                <div className="font-mono text-[10px] uppercase tracking-[0.3em] text-text-muted">YouTube</div>
                <div className="mt-1 text-sm font-medium">@1nriworldwide</div>
              </div>
              <div className="mt-auto inline-flex items-center gap-2 text-[10px] font-mono uppercase tracking-[0.3em] text-text-muted group-hover:text-text transition">
                Subscribe
            ...
            >
              ...
              <div>
                <div className="font-mono text-[10px] uppercase tracking-[0.3em] text-text-muted">LinkedIn</div>
          ...
          <motion.div
            ...
            viewport={viewport}
            variants={stagger}
            className="mt-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-t border-line pt-8"
          >
            <motion.div variants={fadeUp}>
